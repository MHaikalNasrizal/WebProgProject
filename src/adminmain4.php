        ...
        <table class="table">
          ...
          <tbody>
            ...
            while ($table = mysqli_fetch_array($result, MYSQLI_NUM)) {
              ...
              echo "<td><form method='POST' action='delete.php'><button class='btn btn-danger'name='delete1'type='submit' onclick='return myconfirmed()' value='$id'>Delete</button></form></td>";
              echo "</tr>";
